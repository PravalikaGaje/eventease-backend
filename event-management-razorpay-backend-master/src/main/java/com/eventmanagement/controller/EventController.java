...
public class EventController {
	...
	@PostMapping("add")
	public ResponseEntity<CommonApiResponse> addEvent(@ModelAttribute AddEventRequestDto request) {
		return this.eventResource.addEvent(request);
	}

	@PutMapping("update")
	public ResponseEntity<CommonApiResponse> updateEvent(@ModelAttribute AddEventRequestDto request) {
